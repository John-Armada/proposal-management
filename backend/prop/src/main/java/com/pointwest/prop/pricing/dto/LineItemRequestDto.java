...
public class LineItemRequestDto {
    ...
    @AssertTrue(message = "description is required when no catalogItemId is provided")
    public boolean isDescriptionValid() {
        return catalogItemId != null || (description != null && !description.isBlank());
    }

    @AssertTrue(message = "unitPrice is required when no catalogItemId is provided")
    public boolean isUnitPriceValid() {
        return catalogItemId != null || unitPrice != null;
    }
}