...
public class DataSeeder {
                ...
                return args -> {
                        ...
                        if (departmentRepository.count() == 0) {
                                departments = List.of(
                                                ...
                                                new Department(null, "IT", "Information Technology",
                                                                "Manages IT infrastructure, software development, and security.",
                                                                true),
                                                new Department(null, "FIN", "Finance & Accounting",
                                                                "Oversees financial planning, budgeting, and accounting.",
                                                                true),
                                                new Department(null, "MKT", "Marketing & Sales",
                                                                "Drives customer acquisition, brand awareness, and revenue.",
                                                                true),
                                                new Department(null, "OPS", "Operations & Logistics",
                                                                "Coordinates daily operations, supply chain, and workflows.",
                                                                true));
                        ...
                        for (Department dept : departments) {
                                ...
                                for (Role role : roles) {
                                        for (int i = 1; i <= 10; i++) {
                                                ...
                                                user.setEmail(String.format("%s.%s%d@company.com", deptCode, roleCode,
                                                                i));
                        ...
                        Department itDepartment = departmentRepository.findByName("Information Technology")
                                        .orElseThrow(() -> new IllegalStateException(
                                                        "Information Technology department was not seeded"));
                        ...
                        List<Account> accounts = List.of(
                                        account,
                                        findOrCreateAccount(accountRepository, "Globex Industries", "Manufacturing",
                                                        "contact@globex.example"),
                                        findOrCreateAccount(accountRepository, "Wayne Enterprises",
                                                        "Financial Services", "contact@wayne.example"));
        ...
        private void seedProposals(
                ...
                for (ProposalRequest request : requests) {
                        ...
                        proposal.setGoogleDocUrl(
                                        "https://docs.google.com/document/d/seed-proposal-" + (seededCount + 1));
